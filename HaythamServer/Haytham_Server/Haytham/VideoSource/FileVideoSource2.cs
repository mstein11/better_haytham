...
{
    internal class FileVideoSource2 : IVideoSource
    {
        ...
        private void videoFile_NewFrame(object sender, AForge.Video.NewFrameEventArgs eventArgs)
        {
